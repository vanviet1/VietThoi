    ...
    <div className="intropage">
      <div className="container">
        ...
        <div className="row">
          ...
          <p>Coffee House hiện là chuỗi cửa hàng đồ uống lớn nhất tại Việt Nam.
            Những sản phẩm từ Coffee House đang như một cơn bão rất nhanh chóng lan rộng ra xung quanh những nước Châu Á.
            <br />Đi đến đâu sản phẩm của The Coffee House cũng nhận được sự yêu quý của khách hàng các nước. Đây cũng là
            ...
            <br />The Coffee House hiện tại đã có chi nhánh cửa hàng tại Đài Loan, Nhật Bản, Trung Quốc, Hồng Kong, Indonesia,
            Malaisia, Singapor, Việt Nam, Myanma, Brunei, v.v..<br />

            <br />Trong suốt quá trình phát triển của mình The Coffee House luôn tập trung vào việc kết hợp và tạo ra
            ...
            sử dụng trong các sản phẩm của The Coffee House không chỉ vượt qua được chứng nhận SGS Đài Loan
            ...
            quản. Ngoài tính đặc trưng hơn so với các sản phẩm khác, Sản phẩm của The Coffee House còn thể hiện văn hóa trà
            chuyên nghiệp, tinh tế và độc đáo của người Đài Loan.

            <br />
            <br />
            Để luôn có được loại trà tốt nhất, The Coffee House đã ký hợp đồng với những nông dân ở vùng cao.
            ...
            kể so với sản phẩm của The Coffee House.</p>
        </div>
      </div>
