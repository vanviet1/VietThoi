...
const TeaHots = () => {
  ...
  const teahots = products.filter((item) => item.category === "Nước giải khát");
  ...
  return (
    <>
      <div className="container">
        <BreadCrumb title="Nước giải khát" />
      </div>
      <div className="products mb-5">
        <div className="container">
          <h4 className="text-uppercase">Nước giải khát</h4>
          <>
